...
def load():
    global t, t2, t3, t4, t5, t6, t7, t8, t9, t0, m1, m2, m3, m4, m5, m6, m9
...
def draw():
    global click1, click2, click3, click4, click5, click6, click7, click8, click9, tt, display, click10, click11, click12, click13, click14, click15, click16, click19
    #Fundo
...
def conta():
    global display, sinal

    num1 = float(guard)
    num2 = float(guard2)

    if sinal == "+":
        display = str(num1 + num2)
    elif sinal == "-":
        display = str(num1 - num2)
    elif sinal == "*":
        display = str(num1 * num2)
